...
export type LogoFacebook3IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function LogoFacebook3Icon(props: LogoFacebook3IconProps) {
...
export default LogoFacebook3Icon;
/* prettier-ignore-end */
